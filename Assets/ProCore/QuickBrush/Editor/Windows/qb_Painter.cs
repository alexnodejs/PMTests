...
//        window.builtStyles = true; 
	...
	private static void LoadTextures()
	{
		...
		addPrefabTexture				=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_addPrefabIcon.tga", typeof(Texture2D)) as Texture2D;
		addPrefabFieldTexture			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_addPrefabField.tga", typeof(Texture2D)) as Texture2D;
		removePrefabXTexture_normal		=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_removePrefabXIcon_normal.tga", typeof(Texture2D)) as Texture2D;
		removePrefabXTexture_hover 		=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_removePrefabXIcon_hover.tga", typeof(Texture2D)) as Texture2D;
		
		selectPrefabCheckTexture_off	=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_selectPrefabCheck_off.tga", typeof(Texture2D)) as Texture2D;
		selectPrefabCheckTexture_on 	=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_selectPrefabCheck_on.tga", typeof(Texture2D)) as Texture2D;
		selectPrefabCheckTexture_active =		AssetDatabase.LoadAssetAtPath(skinPath + "qb_selectPrefabCheck_active.tga", typeof(Texture2D)) as Texture2D;
		
		prefabFieldBackgroundTexture 	=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_prefabFieldBackground.tga", typeof(Texture2D)) as Texture2D;
		
		brushIcon_Active 				=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_brushIcon_Active.tga", typeof(Texture2D)) as Texture2D;
		brushIcon_Inactive 				=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_brushIcon_Inactive.tga", typeof(Texture2D)) as Texture2D;
		brushIcon_Locked				=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_brushIcon_Locked.tga", typeof(Texture2D)) as Texture2D;
		
		eraserIcon_Active				=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_eraserIcon_Active.tga", typeof(Texture2D)) as Texture2D;
		eraserIcon_Inactive				=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_eraserIcon_Inactive.tga", typeof(Texture2D)) as Texture2D;		
		
		placementIcon_Active			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_placementIcon_Active.tga", typeof(Texture2D)) as Texture2D;
		
		savedBrushIcon					=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_SavedBrushIcon.tga", typeof(Texture2D)) as Texture2D;
		savedBrushIcon_Active			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_SavedBrushIcon_Active.tga", typeof(Texture2D)) as Texture2D;
		
		loadBrushIcon					=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_LoadBrushIcon.tga", typeof(Texture2D)) as Texture2D;
		loadBrushIcon_hover				=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_LoadBrushIcon_hover.tga", typeof(Texture2D)) as Texture2D;
		loadBrushIconLarge				=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_LoadBrushIconLarge.tga", typeof(Texture2D)) as Texture2D;
		loadBrushIconLarge_hover		=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_LoadBrushIconLarge_hover.tga", typeof(Texture2D)) as Texture2D;
		
		saveIcon						=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_SaveIcon.tga", typeof(Texture2D)) as Texture2D;
		saveIcon_hover					=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_SaveIcon_hover.tga", typeof(Texture2D)) as Texture2D;
		
		clearBrushIcon					= 		AssetDatabase.LoadAssetAtPath(skinPath + "qb_ClearBrushIcon.tga", typeof(Texture2D)) as Texture2D;
		clearBrushIcon_hover			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_ClearBrushIcon_hover.tga", typeof(Texture2D)) as Texture2D;
		
		resetSliderIcon					=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_ResetSliderIcon.tga", typeof(Texture2D)) as Texture2D;
		resetSliderIcon_hover			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_ResetSliderIcon_hover.tga", typeof(Texture2D)) as Texture2D;
		
		templateActiveIcon_on			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_TemplateActiveIcon_on.tga", typeof(Texture2D)) as Texture2D;
		templateActiveIcon_off			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_TemplateActiveIcon_off.tga", typeof(Texture2D)) as Texture2D;
		templateActiveIcon_active		=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_TemplateActiveIcon_active.tga", typeof(Texture2D)) as Texture2D;
		templateTabBackground			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_TemplateTabBackground.tga", typeof(Texture2D)) as Texture2D;
		templateTabBackground_inactive	=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_TemplateTabBackground_inactive.tga", typeof(Texture2D)) as Texture2D;
		
		templateDirtyAsterisk			=		AssetDatabase.LoadAssetAtPath(skinPath + "qb_TemplateDirtyAsterisk.tga", typeof(Texture2D)) as Texture2D;
		
		prefabPaneDropdownIcon_closed_normal =	AssetDatabase.LoadAssetAtPath(skinPath + "qb_prefabPaneDropdownIcon_closed_normal.tga", typeof(Texture2D)) as Texture2D;
		prefabPaneDropdownIcon_closed_active =	AssetDatabase.LoadAssetAtPath(skinPath + "qb_prefabPaneDropdownIcon_closed_active.tga", typeof(Texture2D)) as Texture2D;
		prefabPaneDropdownIcon_open_normal =	AssetDatabase.LoadAssetAtPath(skinPath + "qb_prefabPaneDropdownIcon_open_normal.tga", typeof(Texture2D)) as Texture2D;
		prefabPaneDropdownIcon_open_active =	AssetDatabase.LoadAssetAtPath(skinPath + "qb_prefabPaneDropdownIcon_open_active.tga", typeof(Texture2D)) as Texture2D;
	}
